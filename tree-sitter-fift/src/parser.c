...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_include_directive] = STATE(118),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(127),
  ...
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(135),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  ...
  [127] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(139),
  [130] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(92),
  [133] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(120),
  ...
  [148] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(124),
  ...
  [166] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(153),
  ...
  [178] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(133),
  [181] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(72),
  [184] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_proc_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(117),
  ...
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeat_statement, 3, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_repeat_statement, 3, 0, 0),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifjmp_statement, 2, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ifjmp_statement, 2, 0, 0),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeat_statement, 2, 0, 0),
  [255] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_repeat_statement, 2, 0, 0),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_until_statement, 2, 0, 0),
  [259] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_until_statement, 2, 0, 0),
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_call, 2, 0, 0),
  [263] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_proc_call, 2, 0, 0),
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_identifier, 2, 0, 0),
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_identifier, 2, 0, 0),
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3, 0, 0),
  [271] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3, 0, 0),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifjmp_statement, 3, 0, 0),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ifjmp_statement, 3, 0, 0),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_statement, 3, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_statement, 3, 0, 0),
  ...
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 4, 0, 0),
  [295] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 4, 0, 0),
  [297] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_statement, 4, 0, 0),
  [299] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_statement, 4, 0, 0),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stack_ref, 4, 0, 0),
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stack_ref, 4, 0, 0),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 5, 0, 0),
  [307] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 5, 0, 0),
  ...
  [339] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat2, 2, 0, 0), SHIFT_REPEAT(106),
  [342] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0),
  [344] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(131),
  [347] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0),
  [349] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(122),
  ...
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 3, 0, 3),
  [366] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 3, 0, 3),
  [368] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 2, 0, 2),
  [370] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 2, 0, 2),
  [372] = {.entry = {.count = 1, .reusable = true}}, SHIFT(144),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat3, 2, 0, 0),
  [376] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat3, 2, 0, 0), SHIFT_REPEAT(132),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_definition, 4, 0, 2),
  [381] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_proc_definition, 4, 0, 2),
  [383] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_inline_definition, 4, 0, 2),
  [385] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_proc_inline_definition, 4, 0, 2),
  [387] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_definition, 4, 0, 2),
  [389] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_method_definition, 4, 0, 2),
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_ref_definition, 4, 0, 2),
  [393] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_proc_ref_definition, 4, 0, 2),
  [395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_definition, 3, 0, 2),
  [397] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_proc_definition, 3, 0, 2),
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_inline_definition, 3, 0, 2),
  [401] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_proc_inline_definition, 3, 0, 2),
  [403] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 1, 0, 0),
  [405] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 1, 0, 0),
  ...
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_var, 2, 0, 1),
  ...
  [435] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 4, 0, 0),
  [437] = {.entry = {.count = 1, .reusable = true}}, SHIFT(126),
  [439] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 2, 0, 0),
  ...
  [477] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_include_directive, 4, 0, 0),
